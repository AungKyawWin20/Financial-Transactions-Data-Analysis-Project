...
correlation <- cor(data4$credit_limit, data4$credit_score, use = "complete.obs")

# Print the correlation result
print(paste("Correlation between Credit Limit and Credit Score: ", round(correlation, 2)))

# Create a scatter plot
ggplot(data4, aes(x = credit_score, y = credit_limit)) +
  geom_point(alpha = 0.5, color = "blue") +
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  labs(
    title = "Relationship between Credit Score and Credit Limit",
